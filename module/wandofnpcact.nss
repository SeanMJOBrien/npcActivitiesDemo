...
/*    if (GetIsDM(oPC) == FALSE)
    ...
    if (GetLocalInt(oTarget,"noheart") == 0)
    {
            SendMessageToPC(oPC,"Stopping NPC's heartbeat script: " + GetName(oTarget));

//            int nGNBDisabled = GetLocalInt(oTarget,"nGNBDisabled");
            SetLocalInt(oTarget,"noheart",1);
        ...
        else if (GetLocalInt(oTarget,"noheart") == 1)
        {
            SendMessageToPC(oPC,"Restarting NPC's heartbeat script: " + GetName(oTarget));

//            int nGNBDisabled = GetLocalInt(oTarget,"nGNBDisabled");
            SetLocalInt(oTarget,"noheart",0);
