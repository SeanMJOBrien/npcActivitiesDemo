void createParty()
{
    location spawnPoint = GetLocation(GetObjectByTag("SpawnFoehere"));
    CreateObject(OBJECT_TYPE_CREATURE, "drgr_ftrlead", spawnPoint);
/*    CreateObject(OBJECT_TYPE_CREATURE, "drgr_sqr1", spawnPoint);
    CreateObject(OBJECT_TYPE_CREATURE, "drgr_sqr1", spawnPoint);
    CreateObject(OBJECT_TYPE_CREATURE, "drgr_ftr3", spawnPoint);
    CreateObject(OBJECT_TYPE_CREATURE, "drgr_sqr1", spawnPoint);
  */
