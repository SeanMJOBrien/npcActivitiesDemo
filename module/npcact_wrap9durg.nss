...
// End random weapon
     ...
     SetAILevel(OBJECT_SELF,AI_LEVEL_NORMAL); //Qlippoth, adding to keep NPC running at normal level even if no PCs in game.
  ...
  ExecuteScript("q_masterdrg",oMe); //Qlippoth
  ActionEquipMostDamagingMelee(); // Qlippoth equip most damaging
}
