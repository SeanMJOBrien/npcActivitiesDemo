////////////////////////////////////////////////////////////////////////////////
// npcact_dl_pos - OnHeartbeat Wrapper (works for NPC ACTIVITIES and RTSA
// Modified to be a possessive script from the standard heartbeat script.
//==============================================================================
...
void main()
{
     ...
     string sVTag=GetLocalString(oMe,"sGNBVirtualTag");
     SetLocalInt(oMe,"bNPCDL_Possess",TRUE);
     if (GetObjectType(oMe)!=OBJECT_TYPE_CREATURE) return; // abort
     if (GetStringLength(sVTag)>0) sWPName="POST_"+sVTag;
     ...
     DelayCommand(6.0,ExecuteScript("npcact_dl_pos",oMe));
}
